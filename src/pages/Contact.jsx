    ...
    <section className="grid">
      ...
      <div className="card" style={{padding:16}}>
        ...
        <div className="mt-3" style={{display:'flex', gap:12, flexWrap:'wrap'}}>
          {profile.links.github && <a className="btn" href={profile.links.github} target="_blank" rel="noreferrer">GitHub</a>}
          {profile.links.linkedin && <a className="btn" href={profile.links.linkedin} target="_blank" rel="noreferrer">LinkedIn</a>}
        </div>
      </div>
    </section>
  )
